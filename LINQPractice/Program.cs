...
namespace LINQPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var productsWithPricesInRange10To20OrderedByPriceAsc = from product in products where product.Price >= 10.00 & product.Price <= 20.00 orderby product.Price ascending select product;
            var productsWithPricesInRange10To20OrderedByPriceAscFunctional = products.OrderBy(product => product.Price).Where(product => (product.Price >= 10.00 & product.Price <= 20.00));
            ...
            var titlesForProductsWithPricesInRange10To20OrderedByTitleAsc = from product in products where product.Price >= 10.00 & product.Price <= 20.00 orderby product.Title ascending select product;
            var titlesForProductsWithPricesInRange10To20OrderedByTitleAscFunctional = products.OrderBy(product => product.Title).Where(product => (product.Price >= 10.00 & product.Price <= 20.00));
            ...
            var idsForProductsWithPricesInRange10To20OrderedByIDDesc = from product in products where product.Price >= 10.00 & product.Price <= 20.00 orderby product.ID descending select product;
            var idsForProductsWithPricesInRange10To20OrderedByIDDescFunctional = products.OrderByDescending(product => product.ID).Where(product => (product.Price >= 10.00 & product.Price <= 20.00));
            ...
            var kitchenProductsOrderedByStockedQuantityFunctional = products.OrderByDescending(product => product.StockedQuantity).Where(product => product.Category == ProductCategory.Kitchen);
            ...
            var productTitleWithID3152 = (from product in products where product.ID == 3152 select product).First();
            var productTitleWithID3152Functional = products.First(product => product.ID == 3152);

            Console.WriteLine("Non-functional:");
            Console.WriteLine(productTitleWithID3152);

            Console.WriteLine("Functional:");
            Console.WriteLine(productTitleWithID3152Functional);
            ...
            var petProductsLowestToHighestPriceFunctional = products.OrderBy(product => product.Price).Where(product => product.Category == ProductCategory.Pet);
            ...
            var productsInIDRange2000To2999OrderedByIDFunctional = products.OrderBy(product => product.ID).Where(product => (product.ID >= 2000 & product.ID <= 2999));
            ...
            var titlesForProductsInIDRange2000To2999OrderedByTitleLengthFunctional = products.OrderBy(product => product.Title.Length).Where(product => (product.ID >= 2000 & product.ID <= 2999)).Select(product => product.Title);
            ...
            var lowStock = from product in products where product.StockedQuantity < 20 select new { product.Title, product.StockedQuantity };
            var lowStockFunctional = products.Where(product => (product.StockedQuantity < 20)).Select(product => new { product.Title, product.StockedQuantity });
            ...
            var lowStockOrderedByStockedQuantity = from product in products where product.StockedQuantity < 20 orderby product.StockedQuantity select new { product.Title, product.StockedQuantity };
            var lowStockOrderedByStockedQuantityFunctional = products.OrderBy(product => product.StockedQuantity).Where(product => (product.StockedQuantity < 20)).Select(product => new { product.Title, product.StockedQuantity });
